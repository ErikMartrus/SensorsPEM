package pem.trabajoCurso.SensoresPEM;
...
import pem.trabajoCurso.SensoresPEM.films.presenter.PresenterFilms;
import pem.trabajoCurso.SensoresPEM.films.view.IViewFilms;
import pem.trabajoCurso.SensoresPEM.home.presenter.IPresenterHome;
import pem.trabajoCurso.SensoresPEM.home.view.IViewHome;
import pem.trabajoCurso.SensoresPEM.home.presenter.PresenterHome;
import pem.trabajoCurso.SensoresPEM.login.IPresenterLogin;
import pem.trabajoCurso.SensoresPEM.login.IViewLogin;
import pem.trabajoCurso.SensoresPEM.login.LoginActivity;
import pem.trabajoCurso.SensoresPEM.login.PresenterLogin;
import pem.trabajoCurso.SensoresPEM.register.IPresenterRegister;
import pem.trabajoCurso.SensoresPEM.register.IViewRegister;
import pem.trabajoCurso.SensoresPEM.register.PresenterRegister;
import pem.trabajoCurso.SensoresPEM.register.RegisterActivity;
import pem.trabajoCurso.SensoresPEM.series.presenter.IPresenterSeries;
import pem.trabajoCurso.SensoresPEM.series.presenter.PresenterSeries;
import pem.trabajoCurso.SensoresPEM.series.view.IViewSeries;
