package tema4.pem.seriesmania.home.presenter;
...
import tema4.pem.seriesmania.home.model.IModelHome;
import tema4.pem.seriesmania.home.model.ItemFavorites;
import tema4.pem.seriesmania.home.model.ModelHome;
    ...
    private BroadcastReceiver receptorAvisos = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(AppMediador.AVISO_DATOS_LISTOS)){
                ArrayList<ItemFavorites> infoReceta = (ArrayList<ItemFavorites>) intent.getSerializableExtra(AppMediador.CLAVE_LISTA_RECETAS);
